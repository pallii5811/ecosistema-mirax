...
def test_hiring_adapter_stops_only_on_new_unique_employers(monkeypatch: pytest.MonkeyPatch) -> None:
    ...
    async def _provider(request: AdapterDiscoveryRequest, state, limit: int):
        ...
        record_a = resolve_employer_identity({
            ...
            "description": "Ruolo dedicato ad acquisizione nuovi clienti B2B sul territorio.",
            "evidence_excerpt": "Responsabile acquisizione nuovi clienti e sviluppo pipeline commerciale.",
            "location": "Milano",
        ...
        record_b = resolve_employer_identity({
            ...
            "vacancy_title": "Sales",
            "description": "Ricerca e acquisizione nuovi clienti enterprise nel mercato sanitario.",
            "evidence_excerpt": "Attivita principali: acquisizione nuovi clienti e gestione trattative.",
            "location": "Milano",
