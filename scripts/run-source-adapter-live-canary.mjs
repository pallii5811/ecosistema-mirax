...
const SPECS = {
  ...
  'hiring-marketing': {
    query: 'Trovami aziende in Italia che stanno assumendo marketing manager, digital marketing specialist, growth manager, performance marketing specialist o social media manager.',
    industries: ['aziende operative'],
    geographies: ['Italia'],
    ...
    requiredAttributes: ['azienda operativa in Italia', 'vacancy marketing verificabile'],
